            ...
            <fieldset class="form-input">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-4 d-flex">
                                <input type="radio" name="arus_pada_tiang" id="arus_pada_tiang_no" class="form-check" value="No" {{ $data->arus_pada_tiang === 'No' ? 'checked' : '' }} {{'disabled'}}>
                                <label for="arus_pada_tiang_no">{{ __('messages.no') }}</label>
                            </div>

                            <div class="col-md-4 d-flex">
                                <input type="radio" name="arus_pada_tiang" id="arus_pada_tiang_yes" class="form-check" value="Yes" {{ $data->arus_pada_tiang === 'Yes' ? 'checked' : '' }} {{'disabled'}}>
                            ...
                            <div class="col-md-4 @if ($data->arus_pada_tiang == 'No' || $data->arus_pada_tiang == '') d-none @endif" id="arus_pada_tiang_amp_div">
                                ...
                                <input type="text" name="arus_pada_tiang_amp" id="arus_pada_tiang_amp" class="form-control" value="{{ $data->arus_pada_tiang_amp }}" required {{'disabled'}}>
                            </div>
                        </div>
                    </div>
                </div>
