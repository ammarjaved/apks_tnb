    ...
    {{-- ID --}}
    <div class="row">
        <div class="col-md-4 col-sm-4 "><label for="zone">ID</label></div>
    ...
    {{-- REPAIR DATE FORM --}}
    <form action="{{ route('substation.update',[app()->getLocale(),$data->id]) }} " id="myForm" method="POST" enctype="multipart/form-data">
        @method('PATCH')
        @csrf
